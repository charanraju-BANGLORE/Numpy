# -*- coding: utf-8 -*-
"""Copy of (problem) - Week 1 Project - PFDI.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1N5dBpfmlItDaHLmD73khhpmt7o56Lxte
...
... # YOUR CODE HERE
matrix[: , 1] = np.round(matrix[:, 1], decimals = 2)
print(matrix[: , 1])
...
... # YOUR CODE HERE
f_vec = np.vectorize(from_location_to_airbnb_listing_in_meters)
print(f_vec(latitude, longitude, matrix[:, 2], matrix[:, 3]))
